...
def get_filt_squared(ds, lfilter, variable='TEMP',dim1='N_PROF',dim2='PRES_INTERPOLATED',bound=True):
...
def get_squared_filt(ds, lfilter, variable='TEMP',dim1='N_PROF',dim2='PRES_INTERPOLATED',bound=True):
    
    ds_squared = ds[[variable]]**2
    ds_squared_filt = ff.get_filt_single(ds_squared, lfilter, variable=variable, dim1=dim1, dim2=dim2,bound=bound)
    
    return ds_squared_filt


def get_EKE(ds, lfilter, variable='TEMP',dim1='N_PROF',dim2='PRES_INTERPOLATED',bound=True):
